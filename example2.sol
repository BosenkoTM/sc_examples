...
contract SecondExampleTokenCoin is MintableToken {
    
    string public constant name = "Second Example Coint Token";
    
    string public constant symbol = "SECT";
...
contract Crowdsale is Ownable {
    ...
    SecondExampleTokenCoin public token = new SecondExampleTokenCoin();
